...
*/
public class cheeseAndFruitScreen implements AppScreen,SubjectInterface{
 
    // instance variables
    private AppScreen bistroScreen;    
     private AppScreen cheeseAndFruitScreen;
     private AppScreen cheeseAndFruitScreenRem;
    ...
    PImage caf = loadImage("cheeseandfruitscreen.PNG");
    private ArrayList<ObserverInterface> observers;
    
    public cheeseAndFruitScreen(){
...
public void setCheeseAndFruitScreenRem (AppScreen scr)
{
  this.cheeseAndFruitScreenRem = scr;
}
    ...
    public void touch(int x, int y) 
    {
        ...
        if (x > int(14) && x < int(486) && y > int(109) && y < int(180))
        {
		notifyObservers();
          appController.setScreen(cheeseAndFruitScreenRem);
        }
    ...
    {     
      ...
      image(caf, 0,0, THE_WIDTH, THE_HEIGHT);
      /*
