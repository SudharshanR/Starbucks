...
*/
public class chickenAndHummusScreen implements AppScreen,SubjectInterface{
    // instance variables
    private AppScreen bistroScreen;    
     private AppScreen chickenAndHummusScreen;
     private AppScreen chickenAndHummusScreenRem;
...
Food food;    
    ...
    PImage cah = loadImage("chickenandhummusscreen.PNG");
    private ArrayList<ObserverInterface> observers;
    
    public chickenAndHummusScreen(){
   ...
   // private MenuCommand menuCommand;
    ...
    public void setBistroScreen (AppScreen scr)
{
  this.bistroScreen = scr;
}
public void setChickenAndHummusScreenRem (AppScreen scr)
{
  this.chickenAndHummusScreenRem = scr;
}
    ...
    {
        if (x > int(7) && x < int(155) && y > int(43) && y < int(87))
        {
          appController.setScreen(bistroScreen);
        }
        if (x > int(14) && x < int(486) && y > int(103) && y < int(174))
        {
		notifyObservers();
          appController.setScreen(chickenAndHummusScreenRem);
        }  
    ...
    {     
      ...
      image(cah, 0,0, THE_WIDTH, THE_HEIGHT);
      /*
