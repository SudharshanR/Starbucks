...
*/
public class chickenAndHummusScreenRem implements AppScreen
{  
    // instance variables
    ...
    PImage[] cahr = 
    {
      loadImage("chickenandhummusscreen_remove.PNG")
    ...
    public void setBistroScreen (AppScreen scr)
{
  this.bistroScreen = scr;
    ...
    {
       System.out.println("Inside touch of Chicken and Hummus Screen");
    ...
    {     
      ...
      image(cahr[0], 0,0, THE_WIDTH, THE_HEIGHT);
      /*
