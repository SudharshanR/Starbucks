...
*/
public class hotMainScreen implements AppScreen
{  
    // instance variables
   ...
   // private MenuCommand menuCommand;
	  ...
	  public void setDrinkMainScreen(AppScreen scr)
    {
       ...
       public void setBrewedTeaScreen(AppScreen scr)
    {
        this.brewedTea = scr;
       // menuCommand = new MenuCommand(this);
    }
...
public void setcardsMainScreen1(AppScreen scr)
    ...
    
    {
       ...
       System.out.println("Mouse x in hot main screen----------->"+x);
       System.out.println("Mouse y in hot main screen----------->"+y);
	    if ((mouseX>24 && mouseX<104) && (mouseY>43 && mouseY<82))
		{
		appController.setScreen(drinkMainScreen);
		}
         if (x > int(1) && x < int(497) && y > int(114) && y < int(212))
        {
          appController.setScreen(brewedCoffe);
        }      
            if (x > int(1) && x < int(499) && y > int(409) && y < int(478))
        {
