...
*/
public class myFavScreen implements AppScreen
{  
    // instance variables
    private AppScreen cardsMainScreen;    
    private AppScreen myFavFoodScreen;
   // private myFavScreen;
   ...
   // private MenuCommand menuCommand;
    ...
    public void setMyFavFoodScreen(AppScreen scr)
    {
        this.myFavFoodScreen = scr;
       // menuCommand = new MenuCommand(this);
    }
...
*/
    ...
    {
       System.out.println("Inside touch of My fav Food Screen");
        ...
        if (x > int(1) && x < int(103) && y > int(674) && y < int(747))
      {
        ...
        if (x > int(14) && x < int(486) && y > int(332) && y < int(391))
      {
        appController.setScreen(myFavFoodScreen);
      }  
    ...
    {     
      ...
      image(myfav[0], 0,0, THE_WIDTH, THE_HEIGHT);
      /*
