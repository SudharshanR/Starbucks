/***
TITLE: CaffeVeronaScreen
Work by: Venkataraman
Use : After the customer chooses the Coffee Form, he selects Caffe Verona to add to his favorites
***/
public class CaffeVeronaScreen implements AppScreen,SubjectInterface{
    // instance variables
    private AppScreen addedCaffeVeronaScreen;  
...
//    private Bar nameBar = new Bar(0, TIMEBARHEIGHT, THE_WIDTH, NAMEBARHEIGHT, "mycardsbar.png");
    ...
    PImage card = loadImage("CafeVerona.PNG");
    private ArrayList<ObserverInterface> observers;
    
    public CaffeVeronaScreen(){
  ...
  //    this.cardsMainScreen = scr;
   ...
   //     this.drinkMainScreen1 = scr;
    ...
    public void setAddedCaffeVeronaScreen(AppScreen scr)
    {
        this.addedCaffeVeronaScreen = scr;
    }
    ...
    {
      if (x > int(12) && x < int(483) && y > int(600) && y < int(663))
      { 
        notifyObservers();
       appController.setScreen(addedCaffeVeronaScreen);
      }
