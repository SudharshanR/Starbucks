/*************
Class: CoffeeProfileScreen
Created by: Venkataraman
After the main screen, the customer chooses coffee and this screen pops up.
*/
public class CoffeeProfileScreen implements AppScreen
{  
    // instance variables
    private AppScreen CoffeeProfileScreen;  
...
//    private Bar nameBar = new Bar(0, TIMEBARHEIGHT, THE_WIDTH, NAMEBARHEIGHT, "mycardsbar.png");
  ...
  //  private ImageButton balanceBox = new ImageButton(int(THE_WIDTH*.173), int(THE_HEIGHT*.58), int(THE_WIDTH*.654), int(THE_HEIGHT*.1626), card[2]);
   ...
   //     this.drinkMainScreen1 = scr;
    ...
    // Constructor
    public void CoffeeProfileScreen()
    {
    ...
    {
       System.out.println("Mouse x in Coffee Profile is----------->"+x);
       System.out.println("Mouse y in Coffee Profile is----------->"+y);
