...
*/
public class refresher implements AppScreen
{  
    // instance variables
    ...
    private AppScreen ref2;
    // Define all the images for the buttons.
    PImage[] hotdrink = 
    {
      loadImage("refresher.PNG")
    ...
    // loadImage("paybutton2.png"),
     ...
     // loadImage("paycard.png")
            ...
            public void setrefresher2(AppScreen scr)
    {
        this.ref2 = scr;
   ...
   // private MenuCommand menuCommand;
    ...
    
    {
        ...
        if ((mouseX>24 && mouseX<104) && (mouseY>43 && mouseY<82))
	   {
        ...
        if (x > int(14) && x < int(484) && y > int(116) && y < int(216))
        {
          appController.setScreen(ref2);
        }      
