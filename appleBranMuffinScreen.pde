...
*/
public class appleBranMuffinScreen implements AppScreen,SubjectInterface{
    // instance variables
    ...
    PImage abm = loadImage("applebranmuffinscreen.PNG");
    private ArrayList<ObserverInterface> observers;
	Food food;
    
    public appleBranMuffinScreen(){
    ...
    public void setBakeryScreen (AppScreen scr)
{
  ...
  public void setAppleBranMuffinScreenRem (AppScreen scr)
{
  this.appleBranMuffinScreenRem = scr;
}
    ...
    {     
      ...
      image(abm, 0,0, THE_WIDTH, THE_HEIGHT);
      /*
