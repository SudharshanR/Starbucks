...
*/
public class cheeseAndFruitScreenRem implements AppScreen
{  
    // instance variables
    ...
    PImage[] cafr = 
    {
      loadImage("cheeseandfruitscreen_remove.PNG")
    ...
    public void setBistroScreen (AppScreen scr)
{
  this.bistroScreen = scr;
    ...
    {
       System.out.println("Inside touch of Cheese and Fruit Screen");
    ...
    {     
      ...
      image(cafr[0], 0,0, THE_WIDTH, THE_HEIGHT);
      /*
