...
*/
public class drinkMainScreen implements AppScreen
{  
    // instance variables
    private AppScreen cardsMainScreen;    
     private AppScreen hotMainScreen;
       private AppScreen coldMainScreen;
	   private MenuCommand1 command;
	  private MenuCommand1 menucommand1  = new MenuCommand1();
    ...
    private Bar nameBar = new Bar(0, TIMEBARHEIGHT, THE_WIDTH, NAMEBARHEIGHT, "mycardsbar.png");        
      public void setcoldMainScreen1(AppScreen scr)
    {
        this.coldMainScreen = scr;
       // menuCommand = new MenuCommand(this);
    } 
	 public void setcommand(MenuCommand1 scr)
    {
        this.command = scr;
       // menuCommand = new MenuCommand(this);
    } 
   ...
   // private MenuCommand menuCommand;
    ...
    public void sethotMainScreen1(AppScreen scr)
    {
        this.hotMainScreen = scr;
       // menuCommand = new MenuCommand(this);
    }  
    ...
    
    {
       ...
       System.out.println("Mouse y is----------->"+y);
		...
		// menucommand1.touch(x,y);
         // appController.setScreen(hotMainScreen);
        }      
          
     if (x > int(265) && x < int(446) && y > int(224) && y < int(496))
        {
		command.touch(x,y);
         //  menucommand1.touch(x,y);
		  //appController.setScreen(coldMainScreen);
        }      
   if (x > int(1) && x < int(103) && y > int(674) && y < int(747))
    ...
    {     
      ...
      image(drink[0], 0,0, THE_WIDTH, THE_HEIGHT);
      /*
