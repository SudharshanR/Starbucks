...
*/
public class rewardd1 implements AppScreen
{  
    // instance variables
    private AppScreen cardsMainScreen;    
  //  private AppScreen ref3;    
     private AppScreen rew2;    
...
public void setrewardd2(AppScreen scr)
    {
        this.rew2 = scr;
    ...
    
    {
       ...
       System.out.println("Mouse y is----------->"+y);
        ...
        if (x > int(397) && x < int(485) && y > int(44) && y < int(82))
        {
          appController.setScreen(rew2);
        }      
