...
*/
public class bistroScreen implements AppScreen
{  
    // instance variables
    private AppScreen foodScreen;    
     private AppScreen cheeseAndFruitScreen;
   ...
   // private MenuCommand menuCommand;
    ...
    public void setCheeseAndFruitScreen(AppScreen scr)
    {
        this.cheeseAndFruitScreen = scr;
       // menuCommand = new MenuCommand(this);
    }
    public void setChickenAndHummusScreen (AppScreen scr)
    {
        this.chickenAndHummusScreen = scr;
    }
  public void setFoodScreen (AppScreen scr)
{
  this.foodScreen = scr;
    ...
    {
       System.out.println("Inside touch of Bistro Screen");
       System.out.println("Mouse x is----------->"+x);
       System.out.println("Mouse y is----------->"+y);
        if (x > int(14) && x < int(484) && y > int(130) && y < int(233))
        {
          appController.setScreen(cheeseAndFruitScreen);
        }      
        if (x > int(14) && x < int(485) && y > int(233) && y < int(335))
        {
          appController.setScreen(chickenAndHummusScreen);
        }
    ...
    {     
      ...
      image(bistro[0], 0,0, THE_WIDTH, THE_HEIGHT);
      /*
