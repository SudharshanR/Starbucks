...
*/
public class BrewedTea implements AppScreen
{  
    // instance variables
  ...
  //  private ImageButton balanceBox = new ImageButton(int(THE_WIDTH*.173), int(THE_HEIGHT*.58), int(THE_WIDTH*.654), int(THE_HEIGHT*.1626), card[2]);
    ...
    } public void setTea1Screen(AppScreen scr)
    {
        this.tea1 = scr;
    }
    
    // Constructor
    public void BrewedTea()
    {
      menuCommand = new MenuCommand(this);
    }
public void setHotMainScreen(AppScreen scr)
    {
    ...
    
    {
      ...
      if (x > int(13) && x < int(484) && y > int(116) && y < int(216))
      {
         System.out.println("beforeeeeeeeeeeeeeee"+y);
        appController.setScreen(tea1);
