...
*/
public class myFavFoodScreen implements AppScreen
{  
    // instance variables
    ...
    */
    ...
    
    {
       ...
       if (x > int(7) && x < int(148) && y > int(44) && y < int(88))
      {
    ...
    {     
      ...
      image(myfavfood[0], 0,0, THE_WIDTH, THE_HEIGHT);
      /*
