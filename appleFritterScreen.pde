...
*/
public class appleFritterScreen implements AppScreen,SubjectInterface{
    // instance variables
    private AppScreen bakeryScreen;    
     //private AppScreen appleBranMuffinScreen;
     private AppScreen appleFritterScreen;
     private AppScreen appleFritterScreenRem;
    ...
    PImage af = loadImage("applefritterscreen.PNG");
    private ArrayList<ObserverInterface> observers;
	Food food;
    
    public appleFritterScreen(){
...
public void setAppleFritterScreenRem (AppScreen scr)
{
  this.appleFritterScreenRem = scr;
}
    ...
    {
       System.out.println("Inside touch of Apple Fritter Screen");
	  ...
	  else if ((x>11 && x<76) && (y>680 && y<736))
      {
        ...
        if (x > int(14) && x < int(486) && y > int(108) && y < int(179))
        {
		notifyObservers();
          appController.setScreen(appleFritterScreenRem);
        } 
    ...
    {     
      ...
      image(af, 0,0, THE_WIDTH, THE_HEIGHT);
      /*
