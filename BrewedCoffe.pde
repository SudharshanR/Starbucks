...
*/
public class BrewedCoffe implements AppScreen
{  
    // instance variables
  ...
  //  private ImageButton balanceBox = new ImageButton(int(THE_WIDTH*.173), int(THE_HEIGHT*.58), int(THE_WIDTH*.654), int(THE_HEIGHT*.1626), card[2]);
    ...
    } public void setBoldPick(AppScreen scr)
    {
        this.boldPick = scr;
    }
    ...
    
    {
      ...
      if (x > int(14) && x < int(484) && y > int(117) && y < int(215))
      {
