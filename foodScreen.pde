...
*/
public class foodScreen implements AppScreen
{  
    // instance variables
   ...
   // private MenuCommand menuCommand;
    ...
    {
       System.out.println("Inside touch of Food Screen");
       System.out.println("Mouse x is----------->"+x);
       System.out.println("Mouse y is----------->"+y);
       if (x > int(14) && x < int(483) && y > int(116) && y < int(183))
        {
          appController.setScreen(bakeryScreen);
        }      
        if (x > int(14) && x < int(485) && y > int(185) && y < int(253))
      {
    ...
    {     
      ...
      image(food[0], 0,0, THE_WIDTH, THE_HEIGHT);
      /*
