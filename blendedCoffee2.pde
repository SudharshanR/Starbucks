...
*/
public class blendedCoffee2 implements AppScreen,SubjectInterface{
    // instance variables
    private AppScreen cardsMainScreen;    
    private AppScreen blecof3;    
    private AppScreen blendedCoffee;
    ...
    PImage hotdrink = loadImage("blendcoffee2.PNG");
    private ArrayList<ObserverInterface> observers;
    
    public blendedCoffee2(){
	...
	public void setBlendedCoffeeScreen (AppScreen scr)
    {
      this.blendedCoffee = scr;
    }

        public void setblendedCoffee3(AppScreen scr)
    {
        this.blecof3 = scr;
   ...
   // private MenuCommand menuCommand;
    ...
    
    {
       ...
       System.out.println("Mouse y is----------->"+y);
        ...
        if (x > int(13) && x < int(484) && y > int(466) && y < int(534))
        {
		notifyObservers();
          appController.setScreen(blecof3);
        }      
          if ((mouseX>24 && mouseX<104) && (mouseY>43 && mouseY<82))
	   {
	    appController.setScreen(blendedCoffee);
	   }
